...
from hocontact.postprocess.util import batched_index_select
from pytorch3d.structures import Meshes

# Transform signed distance function into contact value
...
def calculate_contact_capsule(hand_verts, hand_normals, object_verts, object_normals,
    ...
    """
    if caps_on_hand:
        sdf_obj, dot_obj = capsule_sdf(hand_verts, hand_normals, object_verts, object_normals, caps_rad, caps_top, caps_bot, False) #find closest mesh point Q
        sdf_hand, dot_hand = capsule_sdf(hand_verts, hand_normals, object_verts, object_normals, caps_rad, caps_top, caps_bot, True) #find closest query point V
    else:
